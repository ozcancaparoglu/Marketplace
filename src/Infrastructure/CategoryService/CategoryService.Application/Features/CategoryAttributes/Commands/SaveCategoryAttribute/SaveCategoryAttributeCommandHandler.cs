...
namespace CategoryService.Application.Features.CategoryAttributes.Commands.SaveCategoryAttribute
{
    public class SaveCategoryAttributeCommandHandler : IRequestHandler<SaveCategoryAttributeCommand, Result<string>>
    {
        ...
        public SaveCategoryAttributeCommandHandler(IAsyncCategoryAttributeService categoryAttributeService, IMapper mapper, ILogger<SaveCategoryAttributeCommandHandler> logger)
        {
