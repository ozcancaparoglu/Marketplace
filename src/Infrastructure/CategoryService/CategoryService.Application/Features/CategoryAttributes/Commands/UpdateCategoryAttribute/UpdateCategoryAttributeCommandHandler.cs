...
namespace CategoryService.Application.Features.CategoryAttributes.Commands.UpdateCategoryAttribute
{
    public class UpdateCategoryAttributeCommandHandler : IRequestHandler<UpdateCategoryAttributeCommand, Result<string>>
    {
        private readonly IAsyncCategoryAttributeService _categoryAttributeService;
        private readonly IMapper _mapper;
        private readonly ILogger<UpdateCategoryAttributeCommandHandler> _logger;

        public UpdateCategoryAttributeCommandHandler(IAsyncCategoryAttributeService categoryAttributeService, IMapper mapper, ILogger<UpdateCategoryAttributeCommandHandler> logger)
        {
